...
const BusinessDashboard = () => {
  ...
  useEffect(() => {
    if (!authLoading && !user) navigate("/business");
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <Button asChild size="sm" variant="outline"><Link to={`/business-profile/${user?.id}?source=profile`}><ExternalLink className="h-3 w-3 mr-1" /> View Public Profile</Link></Button>
              </div>
            </div>
          </div>
        </motion.div>
